...
public class DrawContextMixin {
    ...
    private Sprite drawGuiTexture$fixSpriteCrash(GuiAtlasManager instance, Identifier location, Operation<Sprite> original) {
        try {
    ...
    public Scaling drawGuiTexture$fixSpriteCrash(GuiAtlasManager instance, Sprite sprite, Operation<Scaling> original) {
    ...
    public void drawGuiTexture$fixSpriteCrash(DrawContext instance, Sprite sprite, int x, int y, int z, int width, int height, Operation<Void> original) {
        if (sprite != null) {
