...
public class ConfirmLinkOverlayScreen extends ConfirmOverlayScreen {
    ...
    public ConfirmLinkOverlayScreen(BooleanConsumer callback, String link, boolean linkTrusted) {
    ...
    public ConfirmLinkOverlayScreen(BooleanConsumer callback, Text title, String link, boolean linkTrusted) {
        this(callback, title, getConfirmText(linkTrusted, link), link, linkTrusted ? ScreenTexts.CANCEL : ScreenTexts.NO, linkTrusted);
    }

    public ConfirmLinkOverlayScreen(BooleanConsumer callback, Text title, Text message, String link, Text noText, boolean linkTrusted) {
    ...
    public static void open(Screen parent, String url) {
        ...
        MTWModClient.instance.setOverlayScreen(new ConfirmLinkOverlayScreen((confirmed) -> {
            if (confirmed) {
